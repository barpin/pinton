...
const pages = {
    'vista_general': () => {
        ...
        console.log(donuts);
        flinea.render(React.createElement(Linechart, { value: [{ name: 'Page A', uv: 4000, pv: 2400, amt: 2400 }, { name: 'Page B', uv: 3000, pv: 1398, amt: 2210 }, { name: 'Page C', uv: 2000, pv: 9800, amt: 2290 }, { name: 'Page D', uv: 2780, pv: 3908, amt: 2000 }, { name: 'Page E', uv: 1890, pv: 4800, amt: 2181 }, { name: 'Page F', uv: 2390, pv: 3800, amt: 2500 }, { name: 'Page G', uv: 3490, pv: 4300, amt: 2100 }] }));
        for (let x = 0; x < donuts.length; x++) {
            donuts[x].render(React.createElement(DataPies, { value: [{ name: 'A1', value: 200 }, { name: 'A2', value: 300 }, { name: 'B1', value: 100 }, { name: 'B2', value: 80 }, { name: 'B3', value: 40 }, { name: 'B4', value: 30 }, { name: 'B5', value: 50 }, { name: 'C1', value: 100 }, { name: 'C2', value: 200 }, { name: 'D1', value: 150 }, { name: 'D2', value: 50 }] }));
        }
        for (let x = 0; x < stockgraphs.length; x++) {
            stockgraphs[x].render(React.createElement(Stockchart, { value: [{ name: 'Page A', uv: 4000, pv: 2400, amt: 2400 }, { name: 'Page B', uv: 3000, pv: 1398, amt: 2210 }, { name: 'Page C', uv: 2000, pv: 9800, amt: 2290 }, { name: 'Page D', uv: 2780, pv: 3908, amt: 2000 }, { name: 'Page E', uv: 1890, pv: 4800, amt: 2181 }, { name: 'Page F', uv: 2390, pv: 3800, amt: 2500 }, { name: 'Page G', uv: 3490, pv: 4300, amt: 2100 }] }));
        }
        return 1;
    }
    ...
    render() {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    Recharts.Pie,
                    { data: this.props.value, dataKey: 'value', cx: '50%', cy: '50%', innerRadius: 25, outerRadius: 45, fill: '#82ca9d' },
                    ' //label',
                    this.props.value.map((entry, index) => React.createElement(Recharts.Cell, { key: `cell-${index}`, fill: getRandomColor() }))
                ),
                React.createElement(Recharts.Tooltip, null),
                React.createElement(Recharts.Legend, { align: 'right', verticalAlign: 'bottom', width: '150px', iconSize: '8px' })
            )
        );
    }
}
    ...
    render() {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(Recharts.Line, { type: 'monotone', dataKey: 'pv', stroke: '#8884d8', activeDot: { r: 8 } }),
    ...
    render() {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(Recharts.CartesianGrid, null),
                React.createElement(Recharts.Line, { type: 'monotone', dataKey: 'pv', stroke: '#8884d8', dot: '' })
            )
        );
    }
}
